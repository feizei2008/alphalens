...
if __name__ == '__main__':
    prices = pd.read_csv(os.path.join(prices_path, 'daily_prices.csv'), parse_dates=True, index_col=['date'])
    factors = pd.read_csv(os.path.join(factors_path, 'daily_factors.csv'), parse_dates=True, index_col=['date', 'asset'])
    # pandas大于1版本，compute_forward_returns报错：
